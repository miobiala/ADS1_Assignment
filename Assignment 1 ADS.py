...
# Reading my data to a Pandas DataFrame
...
def mypie_plot(fifa_conf, lab_col='confederation', val_col='tv_audience_share',
    ...
    Function to plot a Pie Chart for a Pandas DataFrame
    ...
    # create my piechart with matplotlib.pyplot
    plt.pie(values, labels=labels, autopct='%1.1f%%',
            startangle=60, counterclock=True)

    # setting aspect ratio to give a perfect circle and including title
    plt.axis('equal')
    plt.title(title)
...
# Read my data to a Pandas Dataframe
...
# Reset confederation column the index to create dataframe to be used
